...
import avatarImage from '@/images/logos/personalsite_logo.png'
      ...
      <Link
        ...
        className={clsx(
          ...
          isActive
            ...
            : 'hover:text-lime-700 dark:hover:text-lime-600',
        )}
      >
        {children}
        {isActive && (
          <span className="absolute inset-x-1 -bottom-px h-px bg-linear-to-r from-lime-700/0 via-lime-700/40 to-lime-700/0 dark:from-lime-600/0 dark:via-lime-600/40 dark:to-lime-600/0" />
        )}
      </Link>
    </li>
  )
...
function ThemeToggle() {
  ...
  return (
    ...
    >
      <SunIcon className="h-6 w-6 fill-zinc-100 stroke-zinc-500 transition group-hover:fill-orange-200 group-hover:stroke-zinc-700 dark:hidden [@media(prefers-color-scheme:dark)]:fill-lime-600 [@media(prefers-color-scheme:dark)]:stroke-lime-600 [@media(prefers-color-scheme:dark)]:group-hover:fill-lime-600 [@media(prefers-color-scheme:dark)]:group-hover:stroke-lime-600" />
      <MoonIcon className="hidden h-6 w-6 fill-zinc-700 stroke-zinc-500 transition dark:block [@media_not_(prefers-color-scheme:dark)]:fill-lime-600/10 [@media_not_(prefers-color-scheme:dark)]:stroke-lime-600 [@media_not_(prefers-color-scheme:dark)]:group-hover:stroke-orange-300" />
    </button>
  )
}
